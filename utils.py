...
def sql_query_field_names(column_names, id_index, with_id_field=False):
    sql_query = ""
...
def sql_query_values(field_values, id_index, column_types, str_to_sql_typo, with_id_field=False):
    sql_query = ""
